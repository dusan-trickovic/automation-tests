...
const tool_classes_1 = __nccwpck_require__(6846);
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        const nodeTool = new tool_classes_1.NodeTool();
        const pythonTool = new tool_classes_1.PythonTool();
        const goTool = new tool_classes_1.GoTool();
        try {
            const promises = [
